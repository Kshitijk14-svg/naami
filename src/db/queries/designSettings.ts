...
export const DEFAULT_DESIGN_SETTINGS: Record<string, string> = {
  ...
  hero_bg_image: "",
  hero_bg_fit: "cover",
  collections_bg_image: "",
  collections_bg_fit: "cover",
  loom_bg_image: "",
  loom_bg_fit: "cover",
  new_arrivals_bg_image: "",
  new_arrivals_bg_fit: "cover",
  lookbook_banner_bg_image: "",
  lookbook_banner_bg_fit: "cover",
  hotspot_cards_bg_image: "",
  hotspot_cards_bg_fit: "cover",
  bestsellers_bg_image: "",
  bestsellers_bg_fit: "cover",
  coin_pocket_bg_image: "",
  coin_pocket_bg_fit: "cover",
  shared_moments_bg_image: "",
