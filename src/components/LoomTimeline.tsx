  ...
  return (
    <div className="relative w-full">
      <div
        ...
        // height entirely.
        className="relative w-full h-screen overflow-x-auto overflow-y-hidden snap-x snap-mandatory scrollbar-none md:overflow-hidden md:snap-none"
        style={{ height: "100svh", backgroundColor: "#F4F0E6", ...sectionBackgroundStyle(backgroundImage, backgroundImageFit) }}
      >
        {/* Horizontal Track */}
        <div
          ref={trackRef}
        ...
        >
          ...
          <section
            className="w-[90vw] md:w-screen shrink-0 snap-center h-full flex flex-col md:flex-row items-center justify-between px-6 md:px-24 py-20 relative"
          ...
          <section
            className="w-[90vw] md:w-screen shrink-0 snap-center h-full flex flex-col md:flex-row items-center justify-between px-6 md:px-24 py-20 relative overflow-hidden"
            style={{ backgroundColor: "#F4F0E6" }}
          >
